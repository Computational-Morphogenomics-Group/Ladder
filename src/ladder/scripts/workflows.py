...
import ladder.scripts as scripts # import train_pyro, train_pyro_disjoint_param, get_device
import ladder.data.real_data as utils #import construct_labels, distrib_dataset
...
"""
    ...
    def plot_loss(self, save_loss_path : str = None):
        ...
        """
        scripts.visuals._plot_loss(self.train_loss, self.test_loss, save_loss_path=save_loss_path)
